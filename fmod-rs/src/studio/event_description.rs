...
use super::{EventInstance, LoadingState, ParameterDescription, ParameterID, UserProperty};
...
impl EventDescription {
    ...
    pub fn set_callback<F>(&self, callback: F, mask: FMOD_STUDIO_EVENT_CALLBACK_TYPE) -> Result<()>
    where
