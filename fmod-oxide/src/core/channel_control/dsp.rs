...
impl ChannelControl {
    pub const DSP_HEAD: FMOD_CHANNELCONTROL_DSP_INDEX =
        FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_HEAD;
    pub const DSP_TAIL: FMOD_CHANNELCONTROL_DSP_INDEX =
        FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_TAIL;
    pub const DSP_FADER: FMOD_CHANNELCONTROL_DSP_INDEX =
        FMOD_CHANNELCONTROL_DSP_INDEX_FMOD_CHANNELCONTROL_DSP_FADER;
